...
- 5) Custom cache and shader archive for command-line SwiftPM builds (will reuse this concept in OpenCL backend which has no system shader cache) :white_check_mark:, create pointwise operation ubershaders
...
- 8) Generate a graph in-flight, fuse non-adjacent unary operations, fuse binary operations into unary operation chains
